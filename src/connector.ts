type Item = { "src_id": string, "src": string[], "sys_a": string, "out_a": string[], "sys_b": string, "out_b": string[] }
let FAKE_DATA = [
    {
        "src_id": "fakesrc_1",
        "src": [
...
export function get_next_pair(): Item {
    let uid = "GET_ID"
    return FAKE_DATA.shift() as Item
}